...
ENV_UTILS = env_utils/get_env.c env_utils/save_env.c env_utils/update_env.c env_utils/add_env.c
...
FT_DPRINTF = ft_dprintf/ft_printf.c ft_dprintf/put_vars.c
...
VALGRIND = valgrind --trace-children=yes --show-leak-kinds=all --leak-check=full --track-origins=yes -s --track-fds=all --suppressions=./readline.supp ./minishell
